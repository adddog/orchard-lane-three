...
export default class Hotspots extends BaseModel {
    ...
    handleStoreUpdate() {
        ...
        this.invisibleHotspots.forEach(hotspot =>
            hotspot.storeUpdate(state)
        )
    }
        ...
        this.hotspots = this.configurationStore.hotspots
            ...
            .map(hotspotData => {
                const hotspot = new Hotspot({
                    ...hotspotData,
                    fontJSON: this.configurationStore.fontJSON,
                })
    ...
    */
    onBeforeFrameRendered() {
        ...
        this.invisibleHotspots.forEach(
            hotspot => (hotspot.visible = false)
        )
    }
    ...
    onAfterFrameRendered() {
        ...
        this.invisibleHotspots.forEach(
            hotspot => (hotspot.visible = true)
        )
        this.context.renderingContext.renderer.render(
            this.invisibleHotspotGroup,
            this.context.renderingContext.orthographicCamera
        )
    }
